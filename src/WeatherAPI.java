...
public class WeatherAPI {
    ...
    public static JSONObject getWeatherData(String locationName) {
        ...
        try{
            ...
            // get the current hour data & get the index of our current hour
            ...
            // weather json data object going to acces in our frontend
    ...
    public static JSONArray getLocationData(String locationName) {
        ...
        try {
            ...
            //check response status, 200 means successful
            if(conn.getResponseCode() != 200) {
                ...
                // Analyse/Parse the JSON string into a JSON object
                JSONParser parser = new JSONParser();
